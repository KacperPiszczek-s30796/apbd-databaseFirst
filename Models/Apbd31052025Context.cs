...
namespace DatabaseFirstAproach.Models;

public partial class Apbd31052025Context : DbContext
{
    public Apbd31052025Context()
    {
    }

    public Apbd31052025Context(DbContextOptions<Apbd31052025Context> options)
        : base(options)
    {
    }
